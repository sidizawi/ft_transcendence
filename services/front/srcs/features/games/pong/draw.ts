import { GameState, Button, BUTTON_WIDTH, BUTTON_HEIGHT, BUTTON_MARGIN, SINGLE_PLAYER_BUTTON, 
    TWO_PLAYER_BUTTON, PLAY_AGAIN_BUTTON, MAIN_MENU_BUTTON, ONLINE_BUTTON } from './types';

export const drawMenu = (state: GameState): void => {
...
export const gameLoop = (state: GameState): void => {
...
function sendPaddlePosition(state: GameState, side: 'left' | 'right'): void {
...
export function drawWaitingScreen(state: GameState): void {
