export const translations = {
  de: {
    translation: {
      ...
      verification2FA: '2FA Überprüfung',
      ...
      receivedRequests: 'Eingehende Anfragen',
      accept: 'Akzeptieren',
      reject: 'Ablehnen',
      block: 'Blockieren',
      unblock: 'Entsperren',
      ...
      chat: 'Chat',
      message: 'Nachricht',
      cancelFriendship: 'Freundschaftsanfrage abbrechen',
      ...
      newPassword: 'Neues Passwort',
      confirmPassword: 'Passwort bestätigen',
      passwordIdentical: 'Das neue Passwort muss sich vom alten Passwort unterscheiden',
      profile: 'Profil',
      editProfile: 'Profil bearbeiten',
  ...
  en: {
    translation: {
      ...
      passwordIdentical: 'The new password must be different from the old password',
      ...
      chat: 'Chat',
      message: 'Message',
      cancelFriendship: 'Cancel friend request',
  ...
  fr: {
    translation: {
      ...
      passwordIdentical: 'Le nouveau mot de passe doit être différent de l\'ancien mot de passe',
      ...
      chat: 'Chat',
      message: 'Message',
      cancelFriendship: 'Annuler la demande d\'amis',
  ...
  nl: {
    translation: {
      ...
      verification2FA: '2FA-Verifizierung',
      ...
      addFriend: 'toevoegen als vriend',
      ...
      receivedRequests: 'Ontvangen Verzoeken',
      accept: 'Accepteren',
      reject: 'Weigeren',
      block: 'Blokkeren',
      unblock: 'Deblokkeren',
      ...
      chat: 'Chat',
      message: 'Bericht',
      cancelFriendship: 'vriendschapsverzoek annuleren',
